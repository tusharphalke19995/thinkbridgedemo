...
@Component({
  selector: 'app-gigprenuer-verification-details',
  templateUrl: './gigprenuer-verification-details.component.html',
})
export class GigprenuerVerificationDetailsComponent {
