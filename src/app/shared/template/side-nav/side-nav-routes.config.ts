...
export const ROUTES: SideNavInterface[] = [
    ...
    // }
    {
        path: '/project-verification/post-project-verification',
    ...
    },
    {
        ...
        submenu: [
            {
                path: '/profile-verification/employer-profile',
            ...
            {
                path: '/profile-verification/gigprenuer-profile',
    ...
    },
    {
        ...
        submenu: [
            {
                path: '/verification/employer-verification',
                title: 'Employer',
                iconType: '',
                icon: '',
                iconTheme: '',
            ...
            {
                path: '/verification/gigprenuer-verification',
                title: 'Gigprenuer',
                iconType: '',
                icon: '',
                iconTheme: '',
    ...
    {
        path: '/members-plan/members-plan-details',
        title: 'Members Plan',
        iconType: 'nzIcon',
        iconTheme: 'outline',
        icon: 'file',
    ...
    {
        path: '/manager-faq/manager-faq-details',
        title: 'Manager FAQ',
        iconType: 'nzIcon',
        iconTheme: 'outline',
        icon: 'file',
